      ...
      <div className="overflow-hidden">
        ...
        >
          {skillsData.map((skill, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 transition-all duration-300 rotate- hover:-rotate-1 hover:shadow-lg hover:shadow-lime-400/10 hover:border-lime-400/30 flex-shrink-0"
              style={{ 
