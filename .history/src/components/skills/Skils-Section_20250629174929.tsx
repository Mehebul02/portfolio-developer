  ...
  return (
    <div className="bg-black text-white p-8 md:p-12 lg:p-16 rounded-3xl max-w-[1500px] mx-auto">
      ...
      <div className="overflow-hidden">
        <div
          className="flex flex-col lg:flex-row transition-transform duration-500 ease-in-out gap-6 w "
          style={{
        ...
        >
          {skillsData.map((skill, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 flex-shrink-0 !w-full lg:w-auto"
