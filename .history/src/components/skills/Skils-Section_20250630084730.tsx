        ...
        <div className="lg:max-w-md lg:ml-8">
          ...
          <div className="flex justify-end gap-4">
            <Button
              variant="outline"
              size="icon"
              className="w-12 cursor-pointer h-12 rounded-full border-white/20 bg-transparent hover:bg-white/10 hover:tex text-white transition-all duration-200"
              onClick={prevSlide}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="w-12 h-12 cursor-pointer rounded-full border-white/20 bg-transparent hover:bg-white/10 hover:text-amber-50 text-white transition-all duration-200"
              onClick={nextSlide}
            >
      ...
      <div className="overflow-hidden">
        ...
        >
          {skillsData.map((skill, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 transition-all duration-300 -rotate-2 hover:-rotate-1 hover:shadow-lg hover:shadow-lime-400/10 hover:border-lime-400/30 flex-shrink-0"
              style={{ 
