...
export default function SkillSection() {
  return (
    <div className="bg-black text-white p-8 md:p-12 lg:p-16 rounded-3xl px-10 ">
      {/* Header Section */}
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-12 p-10">
