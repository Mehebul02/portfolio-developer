          ...
          <div className="relative w-full lg:w-1/2 h-96 lg:h-auto">
            <div className="relative w-full h-full flex flex-col gap-8">
              ...
              <div className="flex justify-between gap-4">
                ...
                {/* facebook - top right */}
                <div className="transform rotate-12 scale-75 md:scale-90 lg:scale-100 cursor-pointer">
              ...
              <div className="flex justify-center gap-8">
                {/* CSS Winner */}
                <div className="transform rotate-6 scale-75 md:scale-90 lg:scale-100 cursor-pointer">
                  <div className="bg-white text-gray-900 px-4 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-base font-medium border border-gray-200 shadow-sm">
                    CSS WINNER
                  </div>
                </div>
                ...
                {/* thoughtworks */}
                <div className="transform -rotate-3 scale-75 md:scale-90 lg:scale-100 cursor-pointer">
                  <div className="bg-white text-gray-900 px-4 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-base font-medium border border-gray-200 shadow-sm">
                    /thoughtworks
                  </div>
                </div>
