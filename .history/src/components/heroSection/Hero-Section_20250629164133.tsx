            ...
            <main className=" px-6 lg:px-12 pt-12 lg:pt-24">
                ...
                <div className="flex flex-col lg:flex-row items-center space-x-48  mt-12">
                    ...
                    <div className="mb-12 max-w-2xl">
                        ...
                        {/* CTA Button */}
                        <Button className="bg-transparent border-2 border-black text-black hover:bg-black mt-3 hover:text-white transition-colors rounded-full px-8 py-6 text-lg">
