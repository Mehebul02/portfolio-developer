            ...
            <main className=" px-6 lg:px-12 pt-12 lg:pt-24">
                <div className="flex-1 max-w-4xl">
                    ...
                    <div className="space-y-4 mb-12">
                        <h1 className="text-5xl lg:text-7xl xl:text-8xl font-bold leading-tight text-black">
                            Trusted <span className="bg-black text-white px-4 py-2 rounded-2xl inline-block">Partner</span> for
                        </h1>
                        <h1 className="text-5xl lg:text-7xl xl:text-7xl font-bold leading-tight text-black">
                ...
                <div className="flex flex-col lg:flex-row items-center space-x-48  mt-12">
                    ...
                    <div className="hidden lg:flex flex-col items-start space-y-6 mt-12">
                    ...
                    <div className="mb-12 max-w-2xl">
                        ...
                        {/* CTA Button */}
                        <Button className="bg-transparent border-2 border-black text-black hover:bg-black hover:text-white transition-colors rounded-full px-8 py-6 text-lg">
