                ...
                <div className="flex flex-col lg:flex-row items-center space-x-48  mt-12">
                    ...
                    <div className="hidden lg:flex flex-row gap-6 items-start space-y-6 mt-12">
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            <FaInstagram className="w-6 h-6 text-black cur-p" />
                    ...
                    <div className="mb-12 max-w-2xl">
                        ...
                        {/* CTA Button */}
                        <Button className="bg-transparent border-2 cursor-pointer border-black text-black hover:bg-black mt-6 hover:text-white transition-colors rounded-full px-8 py-6 text-lg">
